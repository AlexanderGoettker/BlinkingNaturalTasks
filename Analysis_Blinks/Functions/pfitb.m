function  [xpar mconf sconf xx Values EstData] = pfitb(dat, varargin )
...
%     figure(5);
    ...
    z=zlo:0.01:zhi; xx=mue + sigma * z; pvval = guess0 + guess + (1-lapse-guess0-guess)* Lpredict((xx-mue)/sigma, lshape);
    
    EstData = guess0 + guess + (1-lapse-guess0-guess)* Lpredict((xval-mue)/sigma, lshape);
    Values = pvval; 
